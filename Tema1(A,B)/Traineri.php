...
<head>
    ...
    <title>Summer School: Traineri</title>
    <style>
         .Site_Page{
        height: 100%;
        width: auto;
...
<body class="Site_Page">
    ...
    <div class="Traineri_Section">
        <p>Din cadrul proiectului nostru "Summer School" vor face parte cei mai buni traineri din domeniul IT</p>
        <p>Va oferim posibilitatea de a studia alauri de ei</p>
    </div>
    <div class="Cadre_Section">
        <div class="Cadru">
        <p>Trainer X</p>
            <img src="avatar2.png" alt="Avatar" class="image">
        </div>
        <div class="Cadru">
            <p>Trainer Y</p>
            <img src="avatar2.png" alt="Avatar" class="image">
